...
func ISendARequestToWithJSONAsString(ctx context.Context, verb, port, hostUrl, endpoint, payload string) (context.Context, error) {
	t := bddcontext.LoadContext(ctx)
	...
	//if the response type is not json, don't try to parse it.This is useful for analysing content types like pdfs
